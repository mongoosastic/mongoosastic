...
module.exports = function Mongoosastic(schema, options){
  ...
  */
   ...
   * @param options - (optional) special sync options, such as throttled
   * @param query - query for documents you want to synchronize
   */
  schema.statics.synchronize = function(query, options){
    ...
    stream.on('data', function(doc){
      if(options.throttled) stream.pause()
      counter++
      doc.save(function(err){
        if (err) {
            if(options.throttled) stream.resume()
