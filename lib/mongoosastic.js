...
module.exports = function Mongoosastic(schema, options){
  ...
  */
  ...
  schema.statics.search = function(query, options, cb){
    ...
    esClient.search(esQuery).then(function(res){
...
function createMappingIfNotPresent(options, cb) {
  ...
  generator.generateMapping(schema, function(err, mapping) {
    ...
    client.indices.exists({index: indexName}).then(function(exists){
      if (exists) {
        ...
        client.indices.create({index: indexName, body: settings}).then(function(){
          client.indices.putMapping({
            index: indexName,
            type: typeName,
            body: completeMapping
